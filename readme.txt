...
* MFA rescue: suspected prefetch/link-preview shows a confirmation page; append `llar_rescue_confirm=1` (or custom `LLA_MFA_RESCUE_PREFETCH_BYPASS_ARG`) to proceed without burning the one-time link.
