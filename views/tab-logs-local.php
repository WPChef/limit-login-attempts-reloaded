                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="description-additional p-0 mt-0_5">
                            <?php echo sprintf(
                                __( 'Automate your denylist with IP intelligence when you <a href="www.limitloginattempts.com/info.php?id=21" class="unlink link__style_unlink" target="_blank">upgrade to premium</a>.', 'limit-login-attempts-reloaded' ),
    ...
    <div class="add_block__under_table image_plus">
        <div class="row__list">
            <div class="add_block__title">
                ...
                <a href="www.limitloginattempts.com/info.php?id=20" class="button menu__item button__transparent_orange mt-1_5" target="_blank">
