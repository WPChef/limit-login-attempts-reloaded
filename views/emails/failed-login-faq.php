<?php
/**
 * FAQ block for lockout email. Expects $site_domain and $llar_url from controller.
 *
...
<p style="margin:0 0 14px;font-size:14px;line-height:1.5;color:#333333;">
	...
	echo esc_html(
		sprintf(
			...
			__( 'You are receiving this email because there was a failed login attempt on your website %s. If you\'d like to opt out of these notifications, please click the "Unsubscribe" link below.', 'limit-login-attempts-reloaded' ),
			$site_domain
		)
	);
	?>
...
<p style="margin:0 0 14px;font-size:14px;line-height:1.5;color:#333333;">
	...
	<a href="<?php echo esc_url( $llar_url ); ?>" target="_blank" rel="noopener" style="color:#fda33b;text-decoration:underline;"><?php esc_html_e( 'Limit Login Attempts Reloaded website', 'limit-login-attempts-reloaded' ); ?></a>
